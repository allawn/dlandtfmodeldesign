...
def main(_):
    ...
    if FLAGS.job_name == "ps":
        ...
        with tf.device(
            ...
            sm_w = tf.Variable(tf.truncated_normal([FLAGS.hidden_units, 10], tddev=1.0 / math.sqrt(FLAGS.hidden_units)),
                               name="sm_w")
...
sv = tf.train.Supervisor(is_chief=(FLAGS.task_index == 0), logdir="/tmp/train_logs", init_op=init_op, summary_op=summary_op,
