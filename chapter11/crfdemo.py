...
log_likelihood, transition_params = crf_log_likelihood(inputs=logits, tag_indices=label_data,
...
accuracy = tf.cast(correct, tf.float32) / tf.cast(tf.reduce_sum(sequence_length), tf.float32,
                                                  name='accuracy')
print(accuracy)
